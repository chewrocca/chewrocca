<h1 align="center">Matthew&nbsp;Fine</h1>
...
I build the plumbing that turns a noisy distributed system into something you can actually ask questions of, instrumented end-to-end with **OpenTelemetry** and surfaced in **Grafana**.
...
<img src="https://img.shields.io/badge/Argo%20CD-181717?logo=argo&logoColor=EF7B4D&style=flat-square" alt="Argo CD">&nbsp;
<img src="https://img.shields.io/badge/Go-181717?logo=go&logoColor=00ADD8&style=flat-square" alt="Go">&nbsp;
<img src="https://img.shields.io/badge/Terraform-181717?logo=terraform&logoColor=844FBA&style=flat-square" alt="Terraform">
</p>

### What I'm building

**[bambu-sync](https://github.com/chewrocca/bambu-sync)**
Prometheus exporter for the Bambu Lab Cloud API: print history, RFID filament inventory, MakerWorld favourites.

**[Slay Rat](https://slayrat.com)**
...
<a href="https://slayrat.com">
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://raw.githubusercontent.com/chewrocca/chewrocca/slayrat/images/slayrat-dark.svg">
  <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/chewrocca/chewrocca/slayrat/images/slayrat-light.svg">
  <img alt="My GitHub contribution graph, slashed by Slay Rat" src="https://raw.githubusercontent.com/chewrocca/chewrocca/slayrat/images/slayrat-dark.svg">
</picture>
</a>
